			...
			<Section>
				<div style={{ marginBottom: 20 }}>
					...
					<div>
						...
						<p className="text-xs mt-1 mb-0">
							<span className="text-description">
								Enables advanced Jupyter Notebook (.ipynb) support with cell-level context awareness. When enabled,
								Cline can read and edit notebook cells while preserving the JSON structure. Includes special
								commands for generating, explaining, and improving notebook cells.
							</span>
						</p>
					</div>
